...
import pdb
import rospkg
from QtableSave import QtableSave
...
if __name__ == '__main__':
    ...
    pkg_path = rospack.get_path('tmnt_qlearning')
    ...
    fullpath = os.path.join(path, "qtable.pickle")
    my_file = Path(path+ "/qtable.pickle")
    if my_file.exists():
    ...
    #pdb.set_trace()
    QtableSave.saveQtable(q, qlearn.q)
